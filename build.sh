#!/bin/bash
CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o build/easyserver-darwin-amd64 .
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o build/easyserver-linux-amd64 .
CGO_ENABLED=0 GOOS=linux GOARCH=386 go build -o build/easyserver-linux-386 .
